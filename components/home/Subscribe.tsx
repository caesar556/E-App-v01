...
export default function Subscribe() {
  return (
    <div className="bg-black/80 mb-8 w-[90%] sm:w-[70%] lg:w-[40%] mx-auto rounded-2xl shadow-md">
      <div className="mx-auto max-w-screen-xl px-6 py-10 sm:px-8 lg:px-10 text-center">
        ...
        <form className="mx-auto mt-6 flex max-w-md flex-col gap-3 sm:flex-row sm:items-center sm:justify-center">
          <Input
            type="email"
