...
export default function Oauth() {
  return (
    <div className="mt-6">
      <button className="flex justify-center items-center w-full   text-blue-600 bg-white py-2 rounded-full border border-solid border-zinc-200 ">
      ...
      <button className="flex justify-center items-center w-full  mt-6 py-2 text-blue-600 bg-white rounded-full border border-solid border-zinc-200">
        <div className="flex gap-2.5">
          <Image
