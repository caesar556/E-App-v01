...
export default function ProductCard({ product }) {
  return (
    <Card className="w-full max-w-[280px] sm:max-w-[320px] md:max-w-[360px] overflow-hidden bg-black text-white rounded-2xl shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02] mx-auto">
      {/* صورة المنتج */}
      ...
      <CardContent className="p-4 sm:p-5 space-y-3">
        ...
        <Button
          variant="secondary"
          className="w-full bg-white text-black font-medium hover:bg-gray-200 text-sm sm:text-base rounded-xl"
        >
